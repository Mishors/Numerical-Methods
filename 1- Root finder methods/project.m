...
if (a == 1)
    ...
    func = str2func(z);
    if(lower < upper)
        [root,iter,prec,exe_time,allUpper,allLower,allroots,errors,allvalue] = bis(lower,upper,precision,func,max);
        if(iter == 0 &&prec == 0 )
...
elseif (a == 7)
    ...
    output = 4;
    [rootbis,iterbis,precbis,exe_timebis,allUpperbis,allLowerbis,allrootsbis,errorsbis,allvaluebis] = bis(lowerbis,upperbis,precision,func,max);
